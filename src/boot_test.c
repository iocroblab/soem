...
#define FWBUFSIZE (262144 + 256)

uint8 ob;
uint16 ow;
uint32 data;
char filename[256];
char filebuffer[FWBUFSIZE]; // 256KB buffer
int filesize;
int j;
uint16 argslave;
...
{	
	...
	{	
		...
		printf("End BOOT / FoE test, close socket\n");
...
int main(int argc, char *argv[])
{
	...
	{
		printf("Usage: boot_test ifname1 slave fname\n");
