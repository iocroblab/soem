...
boolean = c_ubyte
ec_configdc = _libraries['libsoem.so'].ec_configdc
ec_configdc.restype = boolean
ec_configdc.argtypes = []
uint16 = c_ushort
uint32 = c_uint
ec_dcsync0 = _libraries['libsoem.so'].ec_dcsync0
ec_dcsync0.restype = None
ec_dcsync0.argtypes = [uint16, boolean, uint32, uint32]
ec_dcsync01 = _libraries['libsoem.so'].ec_dcsync01
ec_dcsync01.restype = None
ec_dcsync01.argtypes = [uint16, boolean, uint32, uint32, uint32]
int8 = c_byte
int16 = c_short
int32 = c_int
uint8 = c_ubyte
...
__all__ = ['ECT_SDO_DOWN_INIT_CA', '__uint16_t', 'ECT_REG_DLSTAT',
           ...
           'ECT_MBXT_AOE', 'EC_BUF_COMPLETE', 'ec_dcsync01',
           'timeval', '__uint32_t', 'ECT_SDO_UP_REQ', 'ec_cmdtype',
           '__time_t', 'ECT_UNSIGNED32', 'ECT_SII_SM',
           ...
           'ECT_SOE_EMERGENCY', 'ECT_GET_ODLIST_REQ', '__int32_t',
           'ECT_COES_RXPDO', 'int32', 'ECT_REG_ESCSUP',
           ...
           'ECT_REG_SM1ACT', '__nlink_t', 'ECT_REAL32', 'EC_CMD_FRMW',
           'ECT_REG_DCSOF', 'EC_ERR_NO_SLAVES', 'futimes',
           '__uint64_t', 'fd_set', 'ECT_BOOLEAN', 'ECT_REG_DCSYSDIFF',
           '__off64_t', 'itimerval', '__fd_mask', 'int16',
           ...
           'EC_CMD_FPRW', 'ECT_SOE_READRES', 'EC_BUF_EMPTY',
           ...
           'ECT_INTEGER32', '__ino64_t', 'ECT_REG_EEPCFG',
           'ec_etherheadert', 'ECT_UNICODE_STRING', 'EC_CMD_BWR',
           'EC_BUF_ALLOC', '__caddr_t', 'ECT_REG_PORTDES',
           'ECT_TIME_OF_DAY', '__u_int', '__clock_t', 'timezone',
           '__fsblkcnt_t', 'ECT_REG_TYPE', 'ECT_UNSIGNED8',
           'ECT_REG_DLPORT', 'ECT_REG_DCSYSOFFSET', 'time_t',
           'ECT_REG_STADR', 'EC_STATE_BOOT', 'EC_CMD_ARMW',
           'EC_STATE_OPERATIONAL', 'ECT_MBXT_SOE',
           'ECT_COES_RXPDO_RR', '__gid_t', '__fsid_t',
           'ECT_UNSIGNED64', 'ECT_REG_DCCYCLE1', 'ECT_REG_DCCYCLE0',
           '__u_quad_t', 'ECT_COES_SDORES', 'ECT_COES_SDOREQ',
           'lutimes', 'EC_ECMD_WRITE', 'EC_ECMD_READ', 'ec_comt',
           '__itimer_which', '__pid_t', 'ECT_INTEGER24',
           'ECT_REG_SM0STAT', 'ECT_SOE_WRITERES', '__fsblkcnt64_t',
           'ECT_SOE_WRITEREQ', 'ec_configdc', 'ECT_SII_MBXSIZE',
           'ECT_REG_DCTIME1', 'ECT_REG_DCTIME0', 'ECT_REG_DCTIME3',
           'ECT_REG_DCTIME2', 'EC_ERR_TYPE_SDOINFO_ERROR',
           'ECT_MBXT_VOE', 'ECT_REG_DCSPEEDCNT', 'ECT_REG_ALSTATCODE',
           '__key_t', '__swblk_t', 'ITIMER_PROF', 'ec_err',
           'ECT_REG_DCSTART0', 'EC_CMD_LWR', 'ITIMER_VIRTUAL',
           'EC_STATE_ERROR', 'ECT_MBXT_FOE', 'ECT_OCTET_STRING',
           '__fsfilcnt_t', 'ECT_UNSIGNED24', 'ec_errort', '__quad_t',
