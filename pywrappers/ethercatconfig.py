...
uint8 = c_ubyte
ec_config_init = _libraries['libsoem.so'].ec_config_init
ec_config_init.restype = c_int
ec_config_init.argtypes = [uint8]
ec_config_map = _libraries['libsoem.so'].ec_config_map
ec_config_map.restype = c_int
ec_config_map.argtypes = [c_void_p]
ec_config_map_group = _libraries['libsoem.so'].ec_config_map_group
ec_config_map_group.restype = c_int
ec_config_map_group.argtypes = [c_void_p, uint8]
ec_config = _libraries['libsoem.so'].ec_config
ec_config.restype = c_int
ec_config.argtypes = [uint8, c_void_p]
uint16 = c_ushort
ec_recover_slave = _libraries['libsoem.so'].ec_recover_slave
ec_recover_slave.restype = c_int
ec_recover_slave.argtypes = [uint16]
ec_reconfig_slave = _libraries['libsoem.so'].ec_reconfig_slave
ec_reconfig_slave.restype = c_int
ec_reconfig_slave.argtypes = [uint16]
boolean = c_ubyte
int8 = c_byte
int16 = c_short
int32 = c_int
...
__all__ = ['__uint16_t', 'ECT_REG_DLSTAT',
           ...
           'fd_set', 'ECT_BOOLEAN', 'ECT_REG_DCSYSDIFF',
           'ec_config_init', '__off64_t', 'itimerval', '__fd_mask',
           'int16', 'EC_ECMD_NOP', 'ec_bufT', 'EC_ERR_TYPE_SOE_ERROR',
           'ECT_REG_DLCTL', 'ECT_SII_MANUF', 'getitimer',
           ...
           'EC_CMD_BRW', 'ec_reconfig_slave', 'ec_err_type',
           'ECT_SII_BOOTRXMBX', 'ECT_INTEGER64', 'ec_config_map',
           'ECT_VISIBLE_STRING', 'EC_CMD_LRD', 'ECT_FOE_BUSY',
           'ec_config', 'EC_CMD_BRD', 'ECT_SII_MBXSIZE',
           '__blkcnt64_t', 'ECT_SII_RXMBXADR', '__u_long',
           'EC_CMD_LRW', 'EC_ERR_TYPE_PACKET_ERROR', 'EC_STATE_ACK',
           'ECT_FOE_READ', '__fsfilcnt64_t', 'EC_CMD_APRD',
           ...
           'EC_CMD_APRW', 'timespec', 'ECT_MBXT_VOE', 'ECT_SII_FMMU',
           ...
           'EC_ERR_TYPE_EMERGENCY', 'ECT_REG_SM0', 'ECT_REG_EEPCTL',
           'ECT_SDO_SEG_UP_REQ', 'EC_ERR_NOK', '__suseconds_t',
           'ECT_SII_GENERAL', 'ECT_FOE_ERROR', 'EC_CMD_APWR',
           'ECT_REG_ALCTL', 'EC_STATE_SAFE_OP', 'ECT_SII_PDO',
           ...
           'ECT_MBXT_ERR', 'EC_BUF_TX', 'ECT_REG_DCTIME2',
           'ECT_SDO_UP_REQ_CA', 'ec_recover_slave', 'ECT_FOE_ACK',
           '__socklen_t', 'ECT_REG_DCSYSDELAY', 'fd_mask',
           'ECT_FOE_DATA', 'EC_CMD_FPRW', 'ECT_INTEGER32',
           '__ino64_t', 'ECT_REG_EEPCFG', 'ec_etherheadert',
           'ECT_UNICODE_STRING', 'EC_CMD_BWR', 'ITIMER_REAL',
           '__caddr_t', 'ec_config_map_group', 'ECT_REG_PORTDES',
           'ECT_TIME_OF_DAY', '__u_int', '__clock_t', 'timezone',
           '__fsblkcnt_t', 'ECT_GET_ODLIST_RES', 'ECT_UNSIGNED8',
           'ECT_REG_DLPORT', 'ECT_REG_DCSYSOFFSET', 'time_t',
           'EC_CMD_FRMW', 'EC_STATE_BOOT', 'ECT_GET_ODLIST_REQ',
           ...
           'ECT_COES_RXPDO', 'lutimes', 'EC_ECMD_WRITE', '__id_t',
