...
uint16 = c_ushort
uint32 = c_uint
ec_FOEread = _libraries['libsoem.so'].ec_FOEread
ec_FOEread.restype = c_int
ec_FOEread.argtypes = [uint16, STRING, uint32, POINTER(c_int), c_void_p, c_int]
ec_FOEwrite = _libraries['libsoem.so'].ec_FOEwrite
ec_FOEwrite.restype = c_int
ec_FOEwrite.argtypes = [uint16, STRING, uint32, c_int, c_void_p, c_int]
boolean = c_ubyte
int8 = c_byte
int16 = c_short
int32 = c_int
...
__all__ = ['__uint16_t', 'ECT_REG_DLSTAT',
           ...
           'ec_FOEwrite', 'ECT_SDO_UP_REQ', 'ec_cmdtype', '__time_t',
           'ECT_UNSIGNED32', 'itimerval', 'ECT_SII_SM',
           'N9ec_errort4DOT_22E', 'uint16', 'ECT_REG_PDICTL',
           'ECT_MBXT_COE', 'EC_STATE_PRE_OP', '__qaddr_t',
           'ECT_REG_SM2', 'ECT_TIME_DIFFERENCE', '__u_short',
           '__loff_t', 'ECT_SII_MBXPROTO', 'ECT_SDO_DOWN_INIT_CA',
           ...
           'ECT_GET_OE_RES', 'ECT_REG_SM3', 'ECT_GET_OE_REQ',
           ...
           '__u_long', 'EC_CMD_LRW', 'EC_ERR_TYPE_PACKET_ERROR',
           'EC_STATE_ACK', 'ECT_FOE_READ', '__fsfilcnt64_t',
           'EC_CMD_APRD', '__blkcnt_t', 'ECT_BIT1', 'ECT_BIT2',
           'ECT_BIT3', 'ECT_BIT4', 'ECT_BIT5', 'ECT_BIT6', 'ECT_BIT7',
           'ECT_BIT8', '__ino_t', '__rlim64_t', 'EC_ERR_OK',
           ...
           'ECT_REG_ALCTL', 'EC_STATE_SAFE_OP', 'ECT_SII_MBXSIZE',
           'ECT_SII_PDO', 'ECT_SOE_READREQ', 'ec_FOEread',
           ...
           'ECT_REG_ALSTAT', 'ECT_COES_SDOINFO', 'pselect', 'int8',
